...
import { LineChartOutlined, LaptopOutlined, ConsoleSqlOutlined,LoadingOutlined, SmileOutlined, GlobalOutlined,TeamOutlined , } from '@ant-design/icons';
...
const paragraph1 = "Here is a example of sharing your ppt sliders with the participants. The first page is the welcome page ...\
...
return (
    <Tabs onChange={(slideIndex) => selectTab(slideIndex)}
    activeKey={slideIndex} >
        ...
        <TabPane tab="Indiviual Skill" key="6">    </TabPane>
        <TabPane tab={<span>
          <LaptopOutlined />
          Work Process
        </span>} key="7">    </TabPane>
        <TabPane tab="Time Line Plan" key="8">    </TabPane>
        <TabPane tab={<span>
          <LineChartOutlined />
          Predition in 2021
        </span>} key="9">    </TabPane>
