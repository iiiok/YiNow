    ...
    <div className="accordion">
      ...
      <Collapse onChange={onAccordionChange} activeKey={accordionIndex} destroyInactivePanel={true} accordion>
        ...
        <Panel header="Conclusive Video" key="6">
          <p>
            WebSocket is a simple tcp based protocol which does the initial handshake by http and keeps a persistent tcp
            connection to the server.<br />
            Unlike http, it is a duplex connection that allows client and server push frames from either side. Hence
            allowing the client and server to communicate in more real-time.<br />
            Except the typical initial handhsake which will be in http, rest of the communication is headerless and
            lightweight.
          </p>
