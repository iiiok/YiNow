    ...
    <div className="accordion">
      ...
      <Collapse onChange={onAccordionChange} activeKey={accordionIndex} destroyInactivePanel={true} accordion>
        <Panel header="Support most Web-base Media, Resource and widget" key="1">
          Video, Audio, image, Web Link, Chart, Voting, Bidding,Game,... Two-ways interaction, (Mostly one way [Client])
          As a Remote Control (Public LED, Vending Machine) (Mostly one way [Host]) Real Time Web-Broadcast ,as a
          Information Synchronous System, able to support 1M (Televisions, Concerts, Movice theater,Sport Events, Press
          Conference, On-site Promotion, Seminar)
        ...
        <Panel header="It's a Before, During and After the 'Meeting' Seminar" key="2">
          ...
          <p>
            Let's say, for a one-to-one video conference / "Desktop Sharing" comsumes 2Mbps's network traffic， while
            0.2Mbps for audio + 5M's web meeting
          </p>
        ...
        <Panel header="More Than Just a Meeting-assistant System" key="3">
          <h3>
            With this full-duplex communication protocol, we can do a a lot more than just a meeting-sidekick system
          </h3>
          <h4>
            It's a web-base, that means @Every one is ready to participate, no addictional App. In some case, login is
            not required.
          </h4>
          <ul>
            <li>
